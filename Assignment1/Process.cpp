...
void Process::GetCircleCenter(const CImage& image, const unsigned char mapColor, const unsigned char circleColor, int* const outCenterX, int* const outCenterY)
{
...
void Process::GetCirclePointSum(const CImage& image, const int startX, const int startY, const int findWidth, const int findHeight, const unsigned char mapColor, const unsigned char circleColor, long long* const outXSum, long long* const outYSum, long long* const outPointCount)
{
